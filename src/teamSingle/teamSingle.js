...
import { OtherCardProjects } from "./otherCardProjects";
...
<div className="projects">
        ...
        {data.members!==undefined && !!data.members.length && data.members.filter((m,ind)=>ind<1).map((mem,i)=> {
          return (
            <OtherCardProjects props={handleChange} />
            )
        })}</div>
        ...
        <div className="other-projects">
            {data.members!==undefined && !!data.members.length && data.members.filter((m,ind)=>ind<1).map((mem,i)=> {
          return (
            <singleProjectName props={[mem, handleChange]} />
            )
        })}
